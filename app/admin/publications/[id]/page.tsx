...
import { getPublication, updatePublication } from "@/lib/firebase/adminCrud";
    ...
    <section className="section">
      <div className="container">
        <div className="adminHeaderRow">
          <h1 className="h-serif adminTitle">Edit Publication</h1>
        ...
        <PublicationForm
          ...
          onSave={async (payload) => {
            ...
            const fresh = await getPublication(id);
            setItem(fresh);
          }}
        />
      </div>
