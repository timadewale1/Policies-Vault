...
export default function AdminResearchPage() {
  ...
  async function load() {
    setLoading(true);
    const data = await listAdminResearch();
    setItems(data);
    setLoading(false);
  }
    ...
    <section className="section">
      <div className="container">
        ...
        <div className="adminHeaderRow">
          <h1 className="h-serif adminTitle">Research</h1>

          <Link className="btn adminNewBtn" href="/admin/research/new">
            NEW RESEARCH <span aria-hidden>→</span>
          </Link>
        </div>
